...
plot(log2(rpf_edited_prot$rpf_edited_count), log2(rpf_edited_prot$prot_count), xlab = "Ribosomal Profiling FootPrint edited", ylab = "Proteomics", main = "log2 Read Counts", pch = 19, cex = 0.5) + abline(-7.197960,2.511016 , col = "black") + abline(lm(log2(rpf_edited_prot$prot_count) ~ log2(rpf_edited_prot$rpf_edited_count), data = rpf_edited_prot), col = "blue")
