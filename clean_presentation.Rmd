...
# ribo vs resid
plot(log2(prot_ribo_resid_lengths$ribo_count), model2_resid, xlab = "ribo count", ylab = "resid", main = "", pch = 19, cex = 0.5) 
...
plot(log2(prot_ribo_resid_lengths$CDS_length), model2_resid, xlab = "CDS length count", ylab = "resid", main = "", pch = 19, cex = 0.5)

# Different model!
model3 <- lm(log2(ribo_count) ~ log2(prot_count), data = proteomics_and_ribo_profiling)

plot(log2(prot_ribo_resid_lengths$prot_count), resid(model3), xlab = "proteomics count", ylab = "resid", main = "lm(ribo~prot)", pch = 19, cex = 0.5) 
...
lmodel2(log2(prot_count) ~ log2(ribo_count), data = proteomics_and_ribo_profiling,range.y = "relative",range.x = "relative",nperm = 1000)
...
prot_ribo_resids_RMA %>%  ggplot(aes(x = log2(ribo_count),y = log2(prot_count),color = label)) + geom_point()+geom_abline(intercept = -5.471448, slope = 2.3189631) # geom_text(aes(label = GENE_NAME3))
