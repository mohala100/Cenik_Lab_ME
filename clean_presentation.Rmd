...
```{r}
 test <- get_region_counts(second.ribo,tidy = TRUE,
                        ...
                        length = FALSE,
                        experiment ="GSM1691202")
mappability <- read.csv("/Users/mohanadelchouemi/Desktop/Dr Cenik/RibosomeTranslation/Cenik_Lab_ME/pandaman.csv") %>% mutate(GENE_NAME3 = str_replace(X , "-.*",replacement = "")) %>% select(-X)
